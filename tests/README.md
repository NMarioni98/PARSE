...
## Systems
 ...
 - **/tests/{xyz/gmx}/Example_\*/PoreBlazer/:** contains example files generated when [PoreBlazer v4.0](https://github.com/SarkisovGitHub/PoreBlazer) is run with inputs comparable to PrO-VAT's inputs in run.sh
